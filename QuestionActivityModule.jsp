...
<body>
	...
	<div contenteditable="true" id="edit" onkeyup="go()"
	...
	<div
		...
		<button id="b" class="button" onclick="selectEle('question')">Question</button>
		<button id="b" class="button" onclick="selectEle('optionA')">Option:A</button>
		<button id="b" class="button" onclick="selectEle('optionB')">Option:B</button>
		<button id="b" class="button" onclick="selectEle('optionC')">Option:C</button>
		<button id="b" class="button" onclick="selectEle('optionD')">Option:D</button>
		<button id="b" class="button">Option:E</button>
		<button id="a" class="button" onclick="function()">Option:F</button>
		<button id="b" class="button">Option:G</button>
		<button id="b" class="button">Option:H</button>
		<button id="b" class="button" onclick="selectEle('solution')">Solution:</button>
