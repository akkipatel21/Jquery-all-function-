...
<!-- 				<th class="hid">Type of SubLand</th> -->
  ...
  <option value=" AND ">AND</option>
   <option value=" OR ">OR</option>
		...
		<!-- <input type="button" class="btn btn-success"
			style="left: 918px; position: absolute; color: " name="All" value="See All"
			onclick=seeAll()> -->
	</div>
	...
	function bar() {
	 ...
	 $('#port').change(function(){
		    if(this.checked){
		    	...
		    	document.getElementById("portoperator").value='select';
	 ...
	 $('#minorport').change(function(){
		    if(this.checked){
		    	...
		    	document.getElementById("minorportoperator").value='select';
	 ...
	 $('#airport').change(function(){
		    if(this.checked){
		    	...
		    	document.getElementById("airportoperator").value='select';
	 ...
	 $('#RlyStation').change(function(){
		    if(this.checked){
		    	...
		    	document.getElementById("rsoperator").value='select';
	 ...
	 $('#NationalHighway').change(function(){
		    if(this.checked){
		    	...
		    	document.getElementById("nhoperator").value='select';
	 ...
	 $('#StateHighway').change(function(){
		    if(this.checked){
		    	...
		    	document.getElementById("shoperator").value='select';
	 ...
	 $('#Gasgrid').change(function(){
		    if(this.checked){
		    	...
		    	document.getElementById("gasoperator").value='select';
	 ...
	 $('#Powergrid').change(function(){
		    if(this.checked){
		    	...
		    	document.getElementById("poweroperator").value='select';
...
// 			var avoid='undefined';
// 			var r =  query.split(avoid).join('');
			alert(query);
			var res = r.split(" ");  //split by space
			res.pop();
			alert(query);
			//q=r.substring(0 , r.lastIndexOf("AND"));
			//q=r.substring(0 , r.lastIndexOf( "WHERE" ));
			alert(q);
...
/* 						if($.trim(data)==""){
							rows += '<tr><td colspan="11" style="text-align: center;"><b>No data available</b></td></tr>';
							$('#table').html(rows);
							return false;
						} */
						if(tblNo=='1'){
						...
						if(tblNo=='4'){
							if($.trim(data)==""){
								rows += '<tr><td colspan="11" style="text-align: center;">No data available</td></tr>';
								$('#table').html(rows);
							}
